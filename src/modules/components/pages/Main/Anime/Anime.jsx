...
const Anime = ({t, newSearchAnimeText, useTextChangeHandlers,
   useResetSearchQuery, filteredList, hasResults, isLoading}) => {
  return (
    <section className="anime section">
      <div className={Classes.container}>
        ...
        <AnimeList filteredList={filteredList} hasResults={hasResults} isLoading={isLoading} t={t}/>
      </div>
    </section>
  )
}
